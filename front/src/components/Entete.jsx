...
const Entete = ({benevole, deconnexion}) => {
        ...
        <header className="entete-header">
            <img className="entete-logo" src={logo} alt="Logo La Remise"/>
                <div className="entete-identifiant">
                    ...
                    <button className="entete-btnRemove" onClick={() => deconnexion(null)}><img className="entete-decoImg" src={decoIcon} alt="Bouton Deconnexion"/></button>
                </div>
        </header>   
    )};
